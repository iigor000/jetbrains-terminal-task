...
public class TerminalBufferTest {
    ...
    public void testGetCodepointAt() {
        ...
        int codepoint = buffer.getCodepointAt(0, TEST_SCROLLBACK);
    ...
    public void testGetAttributesAt() {
        ...
        int[] attributres  = buffer.getAttributesAt(0, TEST_SCROLLBACK);
    ...
    public void testGetLineAsString() {
        ...
        String line = buffer.getLineAsString(TEST_SCROLLBACK);
    ...
    public void testMultipleAttributeUpdates() {
        ...
        assertEquals(buffer.getAttributesAt(0, TEST_SCROLLBACK)[0], 10);
        assertEquals(buffer.getAttributesAt(1, TEST_SCROLLBACK)[0], 30);
        assertEquals(buffer.getAttributesAt(2, TEST_SCROLLBACK)[0], 50);
    }
